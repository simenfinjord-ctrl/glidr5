      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex gap-1 border-b border-gray-200">
          <button
            ...
            className={`px-4 py-2.5 text-sm font-medium border-b-2 transition-colors ${tab === "tests" ? "border-indigo-600 text-indigo-600" : "border-transparent text-gray-500 hover:text-gray-700"}`}
                      ...
                      <Card className="fs-card rounded-2xl p-4 sm:p-5 hover:shadow-md transition-shadow cursor-pointer" data-testid={`card-grind-test-${t.id}`}>
                        <div className="flex flex-wrap items-center justify-between gap-2">
                          <div className="flex flex-wrap items-center gap-2">
                            <span className="text-base font-semibold text-gray-900">{t.location}</span>
    ...
    <Card className="fs-card rounded-2xl p-4 sm:p-5" data-testid={`card-grind-day-test-${test.id}`}>
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {gp.stone && (
            <span className="inline-flex rounded-full bg-gray-100 px-2 py-0.5 text-[10px] font-medium text-gray-600">{gp.stone}</span>
          )}
          {gp.pattern && (
            <span className="inline-flex rounded-full bg-gray-100 px-2 py-0.5 text-[10px] font-medium text-gray-600">{gp.pattern}</span>
          )}
          {w && (
            <span className="inline-flex items-center gap-1 rounded-full fs-gradient-emerald px-2 py-0.5 text-[10px] font-medium text-emerald-700 ring-1 ring-emerald-500/10">
              <Thermometer className="h-2.5 w-2.5" /> Snow {w.snowTemperatureC}°C

...
## Overview
Glidr is a full-stack React web application designed to centralize ski testing data, provide advanced analytics, and generate detailed reports for the ski industry. It aims to streamline product testing, athlete profile management, and grinding records, facilitating multi-team collaboration. The platform's core purpose is to accelerate product iteration, enable data-driven decision-making, and enhance product quality for manufacturers and testers, with the ambition to become the global standard for ski testing.
